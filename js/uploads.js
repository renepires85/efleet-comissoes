...
async function processarUpload(input, isArq) {
  ...
  try {
    ...
    const linhas = rows.map(r => ({
      ...
      vendedor_nome: r.vendedor_nome, cliente_cnpj: r.cliente_cnpj, cliente_nome: r.cliente_nome,
      ativacao_fuel: r.ativacao_fuel || null, ativacao_pass: r.ativacao_pass || null,
      ativacao_fines: r.ativacao_fines || null, ativacao_premium: r.ativacao_premium || null,
